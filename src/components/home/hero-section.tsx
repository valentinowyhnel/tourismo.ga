  ...
  return (
    <section className="relative bg-gradient-to-b from-primary/10 to-background pt-16 pb-20 md:pt-24 md:pb-28">
      <div className="absolute inset-0">
        <Image 
          src="https://picsum.photos/seed/gabon-panorama/1920/1080" 
          alt="Breathtaking Gabonese Landscape"
          layout="fill"
          objectFit="cover"
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="max-w-3xl mx-auto text-center">
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold tracking-tight text-primary mb-6">
            Discover the Heart of Africa: <span className="text-accent">Gabon</span>
          </h1>
          <p className="text-lg md:text-xl text-foreground/80 mb-10">
            Embark on an unforgettable journey through Gabon's lush rainforests, pristine beaches, and vibrant culture. Your adventure starts here.
          </p>
